        ...
        >
          ...
          {showMenu && (
            <p>
              <input
                type="text"
                placeholder={Locales['zh_CN']['Filter values'] || 'Filter values'}
                className="pvtSearch"
              ...
              >
                {Locales['zh_CN']['Select'] || 'Select'}{values.length === shown.length ? (Locales['zh_CN']['All'] || ' All') : shown.length}
              </a>{' '}
              <a
                role="button"
                className="pvtButton"
              ...
              >
                {Locales['zh_CN']['Deselect'] || 'Deselect'}{values.length === shown.length ? (Locales['zh_CN']['All'] || ' All') : shown.length}
              </a>
            </p>
          )}
    ...
    return (
      <div className="pvtDropdown" style={{zIndex: this.props.zIndex}}>
        ...
        >
          ...
          {Locales['zh_CN'][this.props.current] || this.props.current || <span>&nbsp;</span>}
        </div>
